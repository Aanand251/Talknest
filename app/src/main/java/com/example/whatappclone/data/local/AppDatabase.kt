package com.example.whatappclone.data.local

import android.content.Context
import androidx.room.Database
import androidx.room.Room
import androidx.room.RoomDatabase
import com.example.whatappclone.data.local.dao.ChatDao
import com.example.whatappclone.data.local.dao.MessageDao
import com.example.whatappclone.data.local.dao.UserDao
